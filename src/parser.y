...
%token T_BITWISE_AND T_BITWISE_OR T_BITWISE_SHR T_ADD T_SUB
%token T_FILE_BINARY
...
T_BYTE_EXPRESSION:
  ...
  | T_BYTE_EXPRESSION T_BITWISE_OR T_BYTE_EXPRESSION {
    $$ = $1 & $3;
  }
...
T_WORD_EXPRESSION:
  ...
  | T_WORD_EXPRESSION T_BITWISE_OR T_WORD_EXPRESSION {
    $$ = $1 & $3;
  }
