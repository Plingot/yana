...
%token T_INES_PRG T_INES_CHR T_INES_MIR T_INES_MAP T_INES_FLAGS7 T_INES_FLAGS9 T_INES_FLAGS10 T_INES_TRAINER
%token T_BANK T_ORG
...
ines_entry:
  ...
  | T_INES_TRAINER T_STRING_LITERAL {
    inesHeader.setTrainerData($2);
  }
  ;
